...
Furthermore, GIS technology also allows civil engineers to visualize spatial data so that they can better assess vulnerability of infrastructure systems based on the infrastructure’s proximity to areas prone to landslide and flooding. For instance, the Slope Engineering Branch established the Slope Management and Risk Tracking (SMART) system that catalogues landslide risk of more than 25,000 slopes across Malaysia. [8]_ The availability of such geo-hazard information allows civil engineers to lead the planning of disaster management measures, in the event of a landslide, and to upgrade protection systems for existing slopes to safeguard critical transport links in the vicinity. This would significantly reduce the degree of damage towards transport and highway systems that are oftentimes disrupted by landslides during monsoon seasons.
